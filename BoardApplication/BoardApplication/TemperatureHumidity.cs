...
namespace it.polito.Gadgeteer
{
    ...
    public class TemperatureSensor : GTM.Module
    {
        ...
        public delegate void MeasurementCompleteEventHandler(TemperatureSensor sender, double temperature, double relativeHumidity);
        ...
        /// <param name="temperature">The measured temperature.</param>
        /// <param name="relativeHumidity">The measured humidity.</param>
        protected virtual void OnMeasurementCompleteEvent(TemperatureSensor sender, double temperature, double relativeHumidity)
        {
