...
{
    /// <summary>
    /// A WebServer module for Microsoft .NET Gadgeteer
    /// </summary>
    public class WebServer : GTM.Module
    {
        ...
        // GTM.Polito.WebServer. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the WebServer module.        
        ...
        public WebServer(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the WebServer is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="WebServer"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="WebServer"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="WebServer"/></param>
        public delegate void ButtonEventHandler(WebServer sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="WebServer"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="WebServer"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="WebServer"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(WebServer sender, ButtonState buttonState)
        {
