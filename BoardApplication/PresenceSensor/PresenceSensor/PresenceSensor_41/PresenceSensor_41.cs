...
namespace Gadgeteer.Modules.polito
{
    ...
    public class PresenceSensor : GTM.Module
    {
        ...
        // GTM.polito.PresenceSensor. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the PresenceSensor module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public PresenceSensor(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the PresenceSensor is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="PresenceSensor"/>.
        /// </summary>
        ...
        /// <param name="state">The state of the button of the <see cref="PresenceSensor"/></param>
        public delegate void ButtonEventHandler(PresenceSensor sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="PresenceSensor"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="PresenceSensor"/> is released.
        /// </summary>
        /// <remarks>
        ...
        protected virtual void OnButtonEvent(PresenceSensor sender, ButtonState buttonState)
        {
