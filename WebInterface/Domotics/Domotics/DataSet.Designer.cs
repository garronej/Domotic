...
namespace Domotics.DataSetTableAdapters {
    ...
    public partial class temperatureTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[temperature] WHERE (([time] = @Original_time))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["domoticConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT time, value FROM dbo.temperature";
        ...
        public virtual int Fill(DataSet.temperatureDataTable dataTable) {
        ...
        public virtual DataSet.temperatureDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet.temperatureDataTable dataTable = new DataSet.temperatureDataTable();
        ...
        public virtual int FillByVoid(DataSet.temperatureDataTable dataTable) {
        ...
        public virtual DataSet.temperatureDataTable GetDataByVoid() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet.temperatureDataTable dataTable = new DataSet.temperatureDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet.temperatureDataTable dataTable) {
        ...
        public virtual int Update(System.DateTime time, double value, System.DateTime Original_time) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(double value, System.DateTime Original_time) {
            return this.Update(Original_time, value, Original_time);
        }
    }
